...
- **Language**: All content in this file should be written in English, with Japanese translations provided as comments.
<!-- **言語**: このファイル内のすべての内容は英語で記述し、日本語訳をコメントとして提供してください。 -->
- **Commit Message Language**: Commit messages should be written in Japanese.
<!-- **コミットメッセージの言語**: コミットメッセージは日本語で記述してください。 -->
- **Code Naming**: Code naming (variable names, function names, etc.) should be in English (camelCase, PascalCase).
<!-- **コード命名**: コードの命名（変数名、関数名など）は英語（キャメルケース、パスカルケース）とします。 -->
- **Content Language**: The content of `CLAUDE.md` and `GEMINI.md` should be written in English, with Japanese translations provided as comments.
<!-- **コンテンツ言語**: `CLAUDE.md` と `GEMINI.md` の内容は英語で記述し、日本語訳をコメントとして提供してください。 -->
